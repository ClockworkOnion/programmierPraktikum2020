public class BoundingBox {
    ...
    public BoundingBox CheckAfterMove(Vec2 movement) {
        return new BoundingBox(new Vec2(min.x + movement.x, min.y + movement.y),
                new Vec2(max.x + movement.x, max.y + movement.y));
    }
}
